...
- **Re-audit log:** 2026-07-31 (`ferraroroberto/github-copilot-usage#8`) — `/design-sync` re-surfaced both WARNs verbatim against unchanged CSS/markup; reconfirmed as accepted exceptions per the reasoning above, no code change needed.
